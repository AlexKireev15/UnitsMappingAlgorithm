...
public:
	...
	virtual bool IsIntersectRect(const Vector2f& position, const Vector2f& size) = 0;
	virtual Vector2f GetPosition() const = 0;
	virtual SDL_FRect GetBBox() const = 0;
...
public:
	...
	bool IsIntersectRect(const Vector2f& position, const Vector2f& size) override;
...
//		return m_pCircle;
//	}
//	bool IsIntersectedWithRect(const RectPtr& pRect, Vector2f& correctionVector) override;
//	bool IsIntersectRect(const Vector2f& position, const Vector2f& size) override;
//
//private:
//	CirclePtr m_pCircle;
